...
if substitute_vars k8s/prometheus-rbac.yaml | kubectl apply -f -; then
    echo "✓ RBAC deployed"
else
...
if substitute_vars k8s/prometheus-pvc.yaml | kubectl apply -f -; then
    echo "✓ PVC deployed"
else
...
if substitute_vars k8s/prometheus-configmap.yaml | kubectl apply -f -; then
...
if substitute_vars k8s/prometheus.yaml | kubectl apply -f -; then
